@AbapCatalog.sqlViewName: '/DMO/ICONNE_R25'
...
define view /DMO/I_Connection_R25
  as select from /dmo/connecti_25 as Connection

  association [1..*] to /DMO/I_Flight_R25 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier25  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport25',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
