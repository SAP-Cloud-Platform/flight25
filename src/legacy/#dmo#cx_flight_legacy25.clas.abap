CLASS /dmo/cx_flight_legacy25 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_25',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_25',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id25 OPTIONAL
        booking_id            TYPE /dmo/booking_id25 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id25 OPTIONAL
        agency_id             TYPE /dmo/agency_id25 OPTIONAL
        customer_id           TYPE /dmo/customer_id25 OPTIONAL
        carrier_id            TYPE /dmo/carrier25-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_25-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_25-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date25 OPTIONAL
        end_date              TYPE /dmo/end_date25 OPTIONAL
        booking_date          TYPE /dmo/booking_date25 OPTIONAL
        flight_date           TYPE /dmo/flight_date25 OPTIONAL
        status                TYPE /dmo/travel_status25 OPTIONAL
        currency_code         TYPE /dmo/currency_code25 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id25,
          mv_booking_id            TYPE /dmo/booking_id25,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id25,
          mv_agency_id             TYPE /dmo/agency_id25,
          mv_customer_id           TYPE /dmo/customer_id25,
          mv_carrier_id            TYPE /dmo/carrier25-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_25-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_25-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date25,
          mv_end_date              TYPE /dmo/end_date25,
          mv_booking_date          TYPE /dmo/booking_date25,
          mv_flight_date           TYPE /dmo/flight_date25,
          mv_status                TYPE /dmo/travel_status25,
          mv_currency_code         TYPE /dmo/currency_code25,
...
CLASS /dmo/cx_flight_legacy25 IMPLEMENTATION.
