...
INTERFACE /dmo/if_flight_legacy25
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL25
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel25     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING25
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking25    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_25
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_25 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT25
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight25 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id25.
  ...
  TYPES booking_id TYPE /dmo/booking_id25.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id25.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL25, /DMO/BOOKING25, /DMO/BOOK_SUP_25 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code25.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code25,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status25,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel25_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id25.
  INCLUDE TYPE /dmo/booking25_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id25.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id25.
  INCLUDE TYPE /dmo/book_sup_25_data.
